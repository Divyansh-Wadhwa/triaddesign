    ...
    <section className="relative min-h-screen pt-20 overflow-hidden quantum-grid">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-12 md:pt-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.h1 
              className="pop-text text-5xl md:text-6xl lg:text-7xl font-extrabold text-[#1F242B] leading-tight"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              <span className="text-[#04121A]">Think.</span>{" "}
              <span className="text-[#04121A]">Train.</span>{" "}
              <br className="hidden md:block" />
              <span className="text-[#00AFCB]">Transform.</span>
            </motion.h1>
